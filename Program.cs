...
string[] antagonistTrait = new string[] { "that is seeking revenge", "that is trying to take over the world",("that is hiding a dark secret"),("that is obsessed with power"),("that is manipulating others for their own gain"),("that is driven by jealousy"),("that is haunted by their past"),("that is trying to prove themselves"),("that is seeking redemption"),("that is determined to destroy their enemies"), ("that is trying to cover up their crimes"),("that is seeking to control others"),("that is trying to achieve immortality"),("that is driven by greed"),("that is trying to create chaos"),("that is seeking to dominate others"),("that is trying to fulfill a prophecy"),("that is obsessed with revenge"),("that is about to give birth to the antichrist") };
