...
string[] strings = new string[] { "Adam Sandler's friend group","A group of friends", "A lone hero", "An unlikely duo", "A family", "A team of misfits", "A secret society",("A mysterious stranger"),("An alien race"),("A talking animal"),("A time traveler"), "The worst friendgroup in existence"};
string[] protagonist = new string[] { "Adam Sandler","a 3D printer enthusiast", "an idiot","a single mother of five","an unfunny comedian","a ruthless dictator", "a brave warrior", "a clever detective", "a rebellious teenager", "a wise mentor", "a cunning villain", "a charming rogue", "a misunderstood genius", "a loyal companion", "a fearless leader", "a reluctant hero" };
