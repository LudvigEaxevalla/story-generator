...
string[] protagonist = new string[] { "an idiot","a single mother of five","an unfunny comedian","a ruthless dictator", "a brave warrior", "a clever detective", "a rebellious teenager", "a wise mentor", "a cunning villain", "a charming rogue", "a misunderstood genius", "a loyal companion", "a fearless leader", "a reluctant hero" };
...
string[] antagonist = new string[] { "the city of Detroit","a republican","their own last braincell","God","a confused demon","a serial killer","Jeffery Dahmer","a ruthless dictator", "a literal baby", "some random guy", "a vengeful ghost", "a really nice but misunderstood person","a child","a corrupt politician", "a good person", "a cunning thief", "a powerful sorcerer", "a dangerous criminal", "a manipulative business tycoon", "a jealous rival", "a monstrous creature", "an evil mastermind" };
string[] antagonistTrait = new string[] { "that is going through a lot right now","that is not very nice","that is seeking revenge", "that is trying to take over the world",("that is hiding a dark secret"),("that is obsessed with power"),("that is manipulating others for their own gain"),("that is driven by jealousy"),("that is haunted by their past"),("that is trying to prove themselves"),("that is seeking redemption"),("that is determined to destroy their enemies"), ("that is trying to cover up their crimes"),("that is seeking to control others"),("that is trying to achieve immortality"),("that is driven by greed"),("that is trying to create chaos"),("that is seeking to dominate others"),("that is trying to fulfill a prophecy"),("that is obsessed with revenge"),("that is about to give birth to the antichrist"), ("that is trying to save the world"), "that is on a mission to kill all puppies" };
string[] motivation = new string[] { "to save the world",("to find true love"),("to uncover a hidden truth"),("to seek revenge"),("to protect their family"),("to achieve greatness"),("to escape their past"),("to discover a new world"),("to prove themselves"),("to fulfill a prophecy"), "to have fun again", "to have something to do", "to save all the puppies" };
...
while (true)
{
    ...
    Console.ForegroundColor = ConsoleColor.Gray;
    await type.TypeWrite(", who must face ", delay);
